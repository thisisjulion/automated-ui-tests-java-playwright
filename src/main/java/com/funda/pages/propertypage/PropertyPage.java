...
public class PropertyPage {
    ...
    public PropertyPage(Page page) {
        ...
        this.price = aboutSection.locator("css=div[class='flex gap-2 font-bold']"); //will be good to replace in future
        this.description = page.locator("css=div[class*='listing-description']");
        this.contactAgentButton = page.getByRole(AriaRole.LINK, name("Neem contact op")).first(); //remove locale dependency from locator
        this.requestViewingButton = page.getByRole(AriaRole.LINK, name("Vraag bezichtiging aan")).first();
