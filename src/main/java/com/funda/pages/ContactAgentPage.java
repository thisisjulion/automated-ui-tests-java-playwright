...
public class ContactAgentPage {
    ...
    public ContactAgentPage(Page page) {
        ...
        this.submitButton = page.getByRole(AriaRole.BUTTON, name("Verstuur bericht")); //better to remove this locale dependency
        this.viewingDetailsForm = page.locator("css=div[class='mt-4 md:ml-7 lg:mr-44']");
        this.mondayOption = page.locator("xpath=//input[@id='checkbox-Ma']/parent::div/parent::div"); //better to remove this day/locale dependency
        this.morningOption = page.locator("xpath=//input[contains(@id,'s morgens')]/parent::div/parent::div"); //better to remove this day/locale dependency
    }
}
